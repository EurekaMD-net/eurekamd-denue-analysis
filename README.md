...
| **v0.2.10**    | Censo wider + locality    | View extension: `censo_municipios` 14→50 cols (religion/lengua/migración/assets/edu/salud) + new `censo_localidades` (193k filas). 2 endpoints `/localities-by-municipio` + `/locality-detail` | ✅ Done             | [v0.2-status.md](docs/v0.2-status.md)                               |
